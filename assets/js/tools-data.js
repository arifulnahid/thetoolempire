...
const TOOLS_DATA = [
  ...
  },
  {
    ...
    description: 'Convert text or variable names to camelCase, PascalCase, snake_case, kebab-case, CONSTANT_CASE, and more.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 18L12 6l6 12"/><path d="M8 14h8"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/camel-case-converter.html',
  },
  {
    id: 'capitalize-each-word',
    title: 'Capitalize Each Word',
    description: 'Instantly capitalize each word in your text — for titles, headlines, names, and headings. Choose Smart Title Case.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 18l3-12 3 12"/><path d="M7.5 13h3"/><path d="M16 8h3"/><path d="M17.5 8v10"/><path d="M16 18h3"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/capitalize-each-word.html',
  },
  {
    id: 'character-counter',
    title: 'Character Counter',
    description: 'Free online character counter. Count characters with and without spaces, letters, numbers, punctuation.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h12"/><path d="M4 12h12"/><path d="M4 18h12"/><path d="M19 8l2 2-2 2"/><path d="M21 10h-5"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/character-counter.html',
  },
  {
    id: 'cobol-case-converter',
    title: 'Cobol Case Converter',
    description: 'Convert any text, phrase, or variable name to COBOL-CASE (all-uppercase, hyphen-separated) instantly.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 18L12 6l6 12"/><path d="M8 14h8"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/cobol-case-converter.html',
  },
  {
    id: 'constant-case-converter',
    title: 'Constant Case Converter',
    description: 'Convert any text, phrase, or variable name to CONSTANT_CASE (SCREAMING_SNAKE_CASE) instantly.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 18L12 6l6 12"/><path d="M8 14h8"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/constant-case-converter.html',
  },
  {
    id: 'dot-case-converter',
    title: 'Dot Case Converter',
    description: 'Free online dot case converter. Instantly turn any text, phrase or camelCase variable into dot.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 18L12 6l6 12"/><path d="M8 14h8"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/dot-case-converter.html',
  },
  {
    id: 'inverse-case-converter',
    title: 'Inverse Case Converter',
    description: 'Free online inverse case converter. Instantly invert every letter\'s capitalization.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 18L12 6l6 12"/><path d="M8 14h8"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/inverse-case-converter.html',
  },
  {
    id: 'line-counter',
    title: 'Line Counter',
    description: 'Free online line counter. Count total lines, blank lines, and duplicate lines in text.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 18L12 6l6 12"/><path d="M8 14h8"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/line-counter.html',
  },
  {
    id: 'lowercase-converter',
    title: 'Lowercase Converter',
    description: 'Free online lowercase converter. Instantly turn any text into lowercase letters, with one-click switches to UPPERCASE.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 18L12 6l6 12"/><path d="M8 14h8"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/lowercase-converter.html',
  },
  {
    id: 'number-counter',
    title: 'Number Counter',
    description: 'A free online number counter for tallying reps, votes, inventory, laps, or anything you need to count.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="#84cc16" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 6h13M7 12h13M7 18h13"/><path d="M3 5v2M3 11v2M3 17v2"/></svg>',
    color: 'linear-gradient(135deg,#fa709b,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/number-counter.html',
  },
  {
    id: 'paragraph-counter',
    title: 'Paragraph Counter',
    description: 'Free online paragraph counter. Count paragraphs, see average paragraph length, spot your longest and shortest paragraphs.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="#f59e0b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4l16 16"/><path d="M9 5h6"/><path d="M12 5v14"/></svg>',
    color: 'linear-gradient(135deg,#fa709f,#fee14f)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/paragraph-counter.html',
  },
  {
    id: 'pascal-case-converter',
    title: 'Pascal Case Converter',
    description: 'Convert any text, phrase, or variable name to PascalCase instantly — plus camelCase, snake_case, kebab-case, CONSTANT_CASE.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="#f97316" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="12" r="2"/><circle cx="16" cy="12" r="2"/><path d="M10 12h4"/><path d="M4 6h16M4 18h16"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/pascal-case-converter.html',
  },
  {
    id: 'reading-time-calculator',
    title: 'Reading Time Calculator',
    description: 'Paste or type your text to instantly see how long it takes to read out loud or silently. Adjustable reading speed.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="#ef4444" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7H20"/><path d="M7 12H16"/><path d="M7 17H20"/><path d="M4 12l3-3M4 12l3 3"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/reading-time-calculator.html',
  },
  {
    id: 'remove-extra-spaces',
    title: 'Remove Extra Spaces',
    description: 'Free online tool to remove extra spaces, blank lines and tabs from text. See exactly where hidden whitespace is hiding.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21l3-1 11-11-2-2L4 18l-1 3z"/><path d="M14 4l2-2 4 4-2 2"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/remove-extra-spaces.html',
  },
  {
    id: 'sentence-case-converter',
    title: 'Sentence Case Converter',
    description: 'Free online sentence case converter. Instantly capitalize the first letter of every sentence.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6M8 13h8M8 17h5"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/sentence-case-converter.html',
  },
  {
    id: 'sentence-counter',
    title: 'Sentence Counter',
    description: 'Free online sentence counter. Count sentences, see average sentence length, spot your longest and shortest sentences.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="8" y="8" width="11" height="13" rx="2"/><path d="M5 16V5a2 2 0 0 1 2-2h9"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/sentence-counter.html',
  },
  {
    id: 'snake-case-converter',
    title: 'Snake Case Converter',
    description: 'Free online snake case converter. Instantly turn any text, phrase or camelCase variable into snake_case.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 7h14M7 11h10M9 15h6"/><path d="M18 18l3 3"/><circle cx="15" cy="15" r="3"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/snake-case-converter.html',
  },
  {
    id: 'speaking-time-calculator',
    title: 'Speaking Time Calculator',
    description: 'Find out how long a speech, script, or presentation will take to deliver out loud.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="7" height="14" rx="1"/><rect x="14" y="5" width="7" height="14" rx="1"/><path d="M6 9h2M17 9h2M6 15h2M17 15h2"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/speaking-time-calculator.html',
  },
  {
    id: 'title-case-converter',
    title: 'Title Case Converter',
    description: 'Free online title case converter. Instantly format headlines with proper Title Case.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="10" r="5"/><path d="M21 21l-4.5-4.5M8 10h4"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/title-case-converter.html',
  },
  {
    id: 'word-counter-new',
    title: 'Word Counter New',
    description: 'Free online word counter. Count words, characters, sentences, paragraphs, reading time and keyword density .',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 5v14M5 8l3-3 3 3M16 19V5M13 16l3 3 3-3"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/word-counter-new.html',
  },
  {
    id: 'uppercase-converter',
    title: 'Upper Case Converter',
    description: 'Free online uppercase converter. Instantly turn any text into UPPERCASE letters.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 18l3-12 3 12M7.5 13h3M16 8h3M17.5 8v10M16 18h3"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/uppercase-converter.html',
  },
  {
    id: 'train-case-converter',
    title: 'Train Case Converter',
    description: 'Free online train case converter. Instantly turn any text, phrase or camelCase variable into Train-Case.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 18L12 6l6 12M8 14h8"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/train-case-converter.html',
  },
  {
    id: 'toggle-case-converter',
    title: 'Toggle Case Converter',
    description: 'Free online toggle case converter. Instantly flip every letter\'s case.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h16M4 12h10M4 18h7"/><circle cx="18" cy="16" r="3"/></svg>',
    color: 'linear-gradient(135deg,#fa709a,#fee140)',
    categories: ['Text', 'Coding'],
    url: 'tools/text/toggle-case-converter.html',
  },
  ...
  },
  {
    ...
    description: 'Plan projects with an interactive Gantt chart. Add tasks with start/end dates, progress %, colours, and group by phase. Day/week/month zoom. Export as PNG or PDF. Auto-saves in your browser.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="5" width="14" height="4" rx="1"/><rect x="7" y="11" width="12" height="4" rx="1"/><rect x="4" y="17" width="16" height="4" rx="1"/></svg>',
    color: 'linear-gradient(135deg,#6366f1,#4f46e5)',
    categories: ['Productivity', 'Design'],
    url: 'tools/design/gantt-chart.html',
  },
  {
    id: 'swot-analysis',
    title: 'SWOT Analysis Maker',
    description: 'Build professional SWOT analysis matrices online. Add Strengths, Weaknesses, Opportunities, and Threats with priority levels and notes. Export as PNG or PDF. Auto-saves in your browser.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>',
    color: 'linear-gradient(135deg,#a78bfa,#7c3aed)',
    categories: ['Productivity', 'Design'],
    url: 'tools/design/swot-analysis.html',
  },
  {
    id: 'timeline-maker',
    title: 'Timeline Maker',
    description: 'Create beautiful vertical or horizontal timelines online. Add events with dates, descriptions, and colors. Export as PNG or PDF. Auto-saves in your browser.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="2" y1="12" x2="22" y2="12"/><circle cx="6" cy="12" r="2.5" fill="currentColor"/><circle cx="12" cy="12" r="2.5" fill="currentColor"/><circle cx="18" cy="12" r="2.5" fill="currentColor"/><line x1="6" y1="12" x2="6" y2="6"/><line x1="12" y1="12" x2="12" y2="18"/><line x1="18" y1="12" x2="18" y2="6"/></svg>',
    color: 'linear-gradient(135deg,#14b8a6,#0d9488)',
    categories: ['Productivity', 'Design'],
    url: 'tools/design/timeline-maker.html',
  },
  {
    id: 'org-chart',
    title: 'Org Chart Maker',
    description: 'Build hierarchical organizational charts with names, roles, departments and colour coding. Zoom, auto-layout, and export as PNG or PDF. Auto-saves in your browser.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="5" r="3"/><circle cx="5" cy="19" r="3"/><circle cx="19" cy="19" r="3"/><line x1="12" y1="8" x2="5" y2="16"/><line x1="12" y1="8" x2="19" y2="16"/></svg>',
    color: 'linear-gradient(135deg,#10b981,#059669)',
    categories: ['Productivity', 'Design'],
    url: 'tools/design/org-chart.html',
  },
  {
    id: 'neumorphism-generator',
    title: 'Neumorphism Generator',
    description: 'Design soft UI neumorphic components with dual-shadow effects. Adjust distance, blur, intensity, shape type, and light direction — copy the ready-to-use CSS in one click.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="4"/></svg>',
    color: 'linear-gradient(135deg,#818cf8,#6366f1)',
    categories: ['Design'],
    url: 'tools/design/neumorphism-generator.html',
  },
  {
    id: 'css-triangle-generator',
    title: 'CSS Triangle Generator',
    description: 'Generate pure-CSS triangles using the border trick. Pick direction (8 orientations), size, and colour — copy the ready-to-paste CSS instantly. No images, no SVG.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 22 22 2 22"/></svg>',
    color: 'linear-gradient(135deg,#f97316,#ea580c)',
    categories: ['CSS'],
    url: 'tools/css/css-triangle-generator.html',
  },
  {
    id: 'flexbox-playground',
    title: 'Flexbox Playground',
    description: 'Interactive CSS Flexbox visualizer. Configure flex-direction, justify-content, align-items, wrap, and per-item flex-grow/shrink/basis properties with live preview.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="9" width="6" height="6" rx="1"/><rect x="10" y="6" width="4" height="12" rx="1"/><rect x="16" y="8" width="6" height="8" rx="1"/></svg>',
    color: 'linear-gradient(135deg,#6366f1,#4f46e5)',
    categories: ['CSS'],
    url: 'tools/css/flexbox-playground.html',
  },
  {
    id: 'css-grid-generator',
    title: 'CSS Grid Generator',
    description: 'Interactive visual CSS Grid builder. Set columns, rows, gaps, and custom track sizes. Drag to place spanning grid items and copy the complete CSS instantly.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>',
    color: 'linear-gradient(135deg,#10b981,#059669)',
    categories: ['CSS'],
    url: 'tools/css/css-grid-generator.html',
  },
  {
    id: 'css-gradient-generator',
    title: 'CSS Gradient Generator',
    description: 'Build linear, radial, and conic CSS gradients with a live colour-stop editor. 12 presets, up to 8 stops, angle controls, and one-click CSS copy.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><defs><linearGradient id="gi" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#f43f5e"/><stop offset=".5" stop-color="#8b5cf6"/><stop offset="1" stop-color="#06b6d4"/></linearGradient></defs><rect x="3" y="3" width="18" height="18" rx="4" stroke="url(#gi)"/><path d="M3 12h18" stroke="url(#gi)"/></svg>',
    color: 'linear-gradient(135deg,#8b5cf6,#6d28d9)',
    categories: ['CSS'],
    url: 'tools/css/css-gradient-generator.html',
  },
  {
    id: 'css-shape-generator',
    title: 'CSS Shape Generator',
    description: '22 pure-CSS shapes including circles, polygons, stars, arrows, chevrons, and a heart. Pick size and colour, see live preview, copy the border-radius or clip-path CSS code.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 22 22 2 22"/><circle cx="17" cy="8" r="3"/><rect x="2" y="14" width="6" height="6" rx="1"/></svg>',
    color: 'linear-gradient(135deg,#f43f5e,#e11d48)',
    categories: ['CSS'],
    url: 'tools/css/css-shape-generator.html',
  },
  {
    id: 'glassmorphism-generator',
    title: 'Glassmorphism Generator',
    description: 'Design frosted-glass UI components with live preview. Adjust blur, opacity, saturation, border, and shadow — then copy the ready-to-use CSS in one click.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="4"/><path d="M3 9h18M9 21V9" stroke-opacity=".5"/><rect x="3" y="3" width="18" height="18" rx="4" fill="rgba(255,255,255,.1)"/></svg>',
    color: 'linear-gradient(135deg,#0ea5e9,#0284c7)',
    categories: ['Design'],
    url: 'tools/design/glassmorphism-generator.html',
  },
  {
    id: 'chart-generator',
  ...
  {
    id: 'instagram-bio-space-generator',
    title: 'Instagram Bio Space Generator',
    description: 'Build perfectly spaced Instagram bios. Add invisible line-break separators, control blank-line gaps between each bio line, insert symbols, preview your profile, and copy.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="3" y1="14" x2="14" y2="14"/><circle cx="19" cy="17" r="3"/><line x1="22" y1="20" x2="20.1" y2="18.1"/></svg>',
    color: 'linear-gradient(135deg,#22d3ee,#0ea5e9)',
    categories: ['social-media', 'content', 'Utilities'],
    url: 'tools/social/instagram-bio-space-generator.html',
  },
  {
    id: 'instagram-caption-formatter',
    title: 'Instagram Caption Formatter',
    description: 'Format captions with bold, italic, and monospace Unicode fonts. Fix Instagram\'s line-break collapse, manage hashtags with a pill editor, insert CTAs, and copy in one click.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 6h16M4 10h16M4 14h10"/><path d="M18 18l-2-2 2-2 2 2-2 2z"/></svg>',
    color: 'linear-gradient(135deg,#d946ef,#a855f7)',
    categories: ['social-media', 'content', 'Utilities'],
    url: 'tools/social/instagram-caption-formatter.html',
  },
  {
    id: 'instagram-grid-splitter',
    title: 'Instagram Grid Splitter',
    description: 'Split any image into a seamless multi-post Instagram grid. Choose 3×3, 3×6 or custom, download tiles numbered in posting order, and preview your profile mockup. No upload.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5"/><line x1="9" y1="2" x2="9" y2="22"/><line x1="15" y1="2" x2="15" y2="22"/><line x1="2" y1="9" x2="22" y2="9"/><line x1="2" y1="15" x2="22" y2="15"/></svg>',
    color: 'linear-gradient(135deg,#833ab4,#e1306c,#f77737)',
    categories: ['social-media', 'image', 'Design'],
    url: 'tools/social/instagram-grid-splitter.html',
  },
  {
  ...
  },
  {
    ...
    description: 'Build JSON-LD FAQPage structured data for Google rich results. Add questions and answers, preview the SERP accordion, validate your markup, and copy ready-to-paste code.',
    ...
    categories: ['SEO', 'Coding', 'content'],
    url: 'tools/seo/faq-schema-generator.html',
  },
  {
    id: 'breadcrumb-schema-generator',
    title: 'Breadcrumb Schema Generator',
    description: 'Generate JSON-LD BreadcrumbList structured data for Google rich results. Build your breadcrumb trail, preview the SERP path, validate the markup, and copy ready-to-paste code.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg>',
    color: 'linear-gradient(135deg,#0ea5e9,#6366f1)',
    categories: ['SEO', 'Coding', 'content'],
    url: 'tools/seo/breadcrumb-schema-generator.html',
  },
  {
    id: 'canonical-tag-generator',
    title: 'Canonical Tag Generator',
    description: 'Generate canonical link tags to prevent duplicate content issues. Build, validate, and preview canonical URLs for any page — with bulk mode for processing multiple URLs at once.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/><line x1="8" y1="8" x2="8.01" y2="8"/></svg>',
    color: 'linear-gradient(135deg,#10b981,#0891b2)',
    categories: ['SEO', 'Coding', 'content'],
    url: 'tools/seo/canonical-tag-generator.html',
  },
  {
    id: 'meta-description-checker',
    title: 'Meta Description Length Checker',
    description: 'Check and optimise your meta descriptions in real time. See pixel-accurate length, a live Google SERP preview, keyword highlighting, bulk checker, and character/pixel limit guidance.',
    ...
    color: 'linear-gradient(135deg,#f59e0b,#ef4444)',
    categories: ['SEO', 'Text', 'content'],
    url: 'tools/seo/meta-description-checker.html',
  },
  ...
  },
  {
    ...
    title: 'PDF Orientation Checker',
    description: 'Detect portrait, landscape, and square pages in any PDF. Shows thumbnails, dimensions in points, paper size names (A4, Letter, A3…), and rotation angles. No upload, 100% private.',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="8" height="11" rx="1.5"/><rect x="13" y="10" width="8" height="11" rx="1.5"/><line x1="5" y1="7" x2="9" y2="7"/><line x1="5" y1="9" x2="9" y2="9"/><line x1="15" y1="14" x2="19" y2="14"/><line x1="15" y1="16" x2="19" y2="16"/></svg>',
    color: 'linear-gradient(135deg,#3b82f6,#1d4ed8)',
    categories: ['PDF', 'utilities'],
    url: 'tools/pdf/pdf-orientation-checker.html',
  },
  {
    id: 'pdf-metadata',
  ...
  // ── YOUTUBE / CONTENT TOOLS ───────────────────────────────────
  {
    ...
    description: 'Preview how your URL looks when shared on Twitter/X, Facebook, Discord, Slack, and WhatsApp. Auto-fetch OG tags from any URL, validate them, and copy the generated HTML meta tags.',
    ...
    categories: ['Utilities', 'content', 'SEO'],
    url: 'tools/utilities/open-graph-preview.html',
  },
  {
    id: 'youtube-chapter-generator',
    title: 'YouTube Chapter Generator',
    description: 'Build, validate, and format YouTube chapter timestamps. Checks YouTube\'s rules — first chapter at 0:00, 3+ chapters, 10-second gap — and outputs a ready-to-paste list.',
    ...
    categories: ['Utilities', 'content', 'youtube', 'social-media'],
    url: 'tools/utilities/youtube-chapter-generator.html',
  },
